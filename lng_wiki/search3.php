...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6"><!-- <div class="sidebar"> -->
                    ...
                    <?php
                        ...
                        if ($rowcount > 0) {
                            while ($row = $result->fetch_assoc()) {
                                $id_arr[$i] = $row['v_id'];
                                $time_arr[$i] = $row['timeCode'];
                                $name_arr[$i] ="<a class='table-link' href='video_info.php?id=".$row['v_id']. "&searchText=" . urlencode($row['vname']) . "&action=sent" . "'>" . $row['vname'] . "</a>";
